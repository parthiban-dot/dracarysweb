...
export const founderProfile = {
  ...
  story: "DRACARYS was born from the realization that standard college portfolios weren't enough. We needed a crucibleâ€”an environment where passion for modern technology could be forged into real, impactful products.",
