export function DragonAtmosphere() {
  return (
    <div className="pointer-events-none fixed inset-0 z-[-1] bg-[#05050a] overflow-hidden">
      ...
      {/* Glowing atmospheric orbs (Optimized for performance: pure CSS, no JS loops) */}
      <div
        className="absolute top-0 left-1/4 w-[500px] h-[500px] bg-primary/10 rounded-full blur-[150px] animate-pulse"
        style={{ animationDuration: '8s' }}
      />
      
      <div
        className="absolute bottom-0 right-1/4 w-[400px] h-[400px] bg-secondary/10 rounded-full blur-[120px] animate-pulse"
        style={{ animationDuration: '10s' }}
      />
      
      {/* Minimal Abstract Dragon Eye in center */}
